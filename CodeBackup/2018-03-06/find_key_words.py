...
csv_file="/home/selvaprakash/BillD/CSV/Venkat.jpg_enh_clean_20180225221556.csv"
head_words = ['Item','ltem','Name','Item Name','ltem Name','Product','Product Name','Prod','Qty','Oty','Quantity','0uantity','Value','Amount','Desc','Description','Particulars','MRP','Rate']
tab_threshold=10
def_line_spacing=15
...
def find_key_words(path):
    ...
    for i   in range(1,len(df_head1)):
        ...
        if (df_head1.loc[i]['X1']) - (df_head1.loc[i-1]['X2'])  < tab_threshold or  \
